    ...
    <div className="w-3/4 m-auto">
      ...
      <div className=" x-cat-group flex justify-center align-center rounded-xl">
        ...
        <div className="x-cat">
          <div
            className="x-cat-img rounded-full flex justify-center align-center"
            onClick={() => categoryClick("Petualangan")}
          >
            <img
        ...
        <div className="x-cat">
          <div
            className="x-cat-img rounded-full flex justify-center align-center"
            onClick={() => categoryClick("Strategi")}
          >
            <img
        ...
        <div className="x-cat">
          <div
            className="x-cat-img rounded-full flex justify-center align-center"
            onClick={() => categoryClick("Simulasi")}
          >
            <img
